...
async function main() {
 ...
 strict donot add: I will generate an HTML recipe for Panta Bhat following the exact format you provided, and then I will create a vibrant and colorful image of Panta Bhat. type of any lines`;
